...
export const Host = ({ viewer, form }: Props & FormComponentProps) => {
  ...
  const handleImageUpload: UploadProps['onChange'] = (info: UploadChangeParam<UploadFile>) => {
    const { file } = info;
    ...
    // dummy code remove after success image uploading
    setImageBase64Value("https://zos.alipayobjects.com/rmsportal/jkjgkEfvpUPVyRjUImniVslZfWPnJuuZ.png");
  };
